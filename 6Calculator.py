...
def press(num): #grafei sto entry oti pqtisate meta ton teleftaio xaraktira
    e.insert(END,num)
...
b7 = Button(screen, text="7", bg="#C96868", fg="white", width=10, height=2,command=lambda: press("6"))
b8 = Button(screen, text="8", bg="#C96868", fg="white", width=10, height=2,command=lambda: press("7"))
b9 = Button(screen, text="9", bg="#C96868", fg="white", width=10, height=2,command=lambda: press("8"))
b0 = Button(screen, text="0", bg="#C96868", fg="white", width=10, height=2,command=lambda: press("9"))
bTeleia = Button(screen, text=".", bg="#C96868", fg="white", width=10, height=2,command=lambda: press("0"))
bC = Button(screen, text="C", bg="#C96868", fg="white", width=10, height=2)
...
bEison = Button(screen, text="=", bg="#C96868", fg="white", width=10, height=2,command=lambda: press("="))
